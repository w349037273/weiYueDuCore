    ...
    <#--<div id="carouselbar" class="carousel slide">-->
        <#--<div class="carousel-inner">-->
            <#--<div class="item active">-->
                <#--<div style="background-image:url('${request.contextPath}/images/banners/banner1.png')">-->
                    <#--<a  class="text-hide" ></a>-->
                <#--</div>-->
            <#--</div>-->
        <#--</div>-->
    ...
    <div>
        <div class="screening-box clearfix">
            <div class="screening-time l">
                <img src="${request.contextPath}/images/icons/cat.png">
                <span><a class="on">运营喵</a></span>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        function getData(pagenumber) {
            ...
            $.get("${request.contextPath}/select/booksbycategory", { categoryId:3,pageNum: i,pageSize:gPageSize}, function (data) {
                if (data) {
