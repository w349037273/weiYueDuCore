...
<#--<div class="bannerbar bannerbar-carousel visible-md visible-lg">-->
    <#--<div id="carouselbar" class="carousel slide">-->
        <#--&lt;#&ndash;<ol class="carousel-indicators">&ndash;&gt;-->
            <#--&lt;#&ndash;<li data-target="#carouselbar" data-slide-to="0" class="active"></li>&ndash;&gt;-->
        <#--&lt;#&ndash;</ol>&ndash;&gt;-->
        <#--<div class="carousel-inner">-->
            <#--<div class="item active">-->
                <#--<div style="background-image:url('${request.contextPath}/images/banners/banner2.png')">-->
                    <#--<a  class="text-hide"></a>-->
                <#--</div>-->
            <#--</div>-->
        <#--</div>-->
...
<#--<div class="cloud-banner" style="background: url('${request.contextPath}/images/banners/banner4.jpg') center no-repeat;">-->
    ...
    <div>
        <div class="screening-box clearfix">
            <div class="screening-time l">
                <img src="${request.contextPath}/images/icons/dog.png">
                <span><p class="on" style="font-size: 12px;color:#999;">产品汪</p></span>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        function getData(pagenumber) {
            ...
            $.get("${request.contextPath}/select/booksbycategory", { categoryId:1,pageNum: i,pageSize:gPageSize}, function (data) {
                if (data) {
        ...
        function insertDiv(json){
            ...
            for (var i = 0; i < json.length; i++) {
                ...
                html += '<a href=\"${request.contextPath}/select/bookdesc/'+json[i].id+'\" style=\"text-decoration : none;\">';
