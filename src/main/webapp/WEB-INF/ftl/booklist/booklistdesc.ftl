...
<link rel="stylesheet" href="${request.contextPath}/css/base.css" media="screen"/>
    ...
    <!--课程列表-->
    <#if booklistdesces?exists>
        <#list booklistdesces?keys as testKey>
            <#assign books = booklistdesces[testKey]>
                <#if books??>
                    <div class="w index-main">
                        <div>
                            <div class="screening-box clearfix" style="float: left">
                                <div class="screening-time l">
                                    <img src="${request.contextPath}/images/icons/level.png">
                                    <span><p class="on" style="font-size: 14px;color:#999;">${testKey}</p></span>
                                </div>
                            </div>
                                                            ...
                                                            <div class="shizhan-info-bottom">
                                                                <div class="bottom-box clearfix">
                                                                    ...
                                                                    <div class="r">
                                                                        ...
                                                                        <p class="shizhan-course-price"></p></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
